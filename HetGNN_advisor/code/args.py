...
def read_args():
	...
	parser.add_argument('--A_n', type = int, default = 7872,
				   help = 'number of author node')
	# parser.add_argument('--P_n', type = int, default = 705,
	# 			   help = 'number of paper node')
	# parser.add_argument('--V_n', type = int, default = 18,
	# 			   help = 'number of venue node')
	parser.add_argument('--in_f_d', type = int, default = 87721,
				   help = 'input feature dimension')
	parser.add_argument('--embed_d', type = int, default = 87721,
				   help = 'embedding dimension')
	parser.add_argument('--lr', type = int, default = 0.001,
				   help = 'learning rate')
	parser.add_argument('--batch_s', type = int, default = 2000,
				   help = 'batch size')
	parser.add_argument('--mini_batch_s', type = int, default = 100,
