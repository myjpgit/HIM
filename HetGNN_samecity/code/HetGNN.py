...
class model_class(object):
    def __init__(self, args):
        ...
        feature_list = [input_data.a_net_embed]
        #print(feature_list)

        for i in range(len(feature_list)):
            feature_list[i] = torch.from_numpy(np.array(feature_list[i].astype(float))).float()
        ...
        self.model = tools.HetAgg(args, feature_list, a_neigh_list_train, a_train_id_list)
