...
flags.DEFINE_string('dataset', 'terror_attack', 'Dataset string.')
...
node_node_1,node_node_2,node_laplacian_1,node_laplacian_2,node_fea,adj,efeature=extract_adj(FLAGS.dataset)
node_node_1=preprocess_adj(node_node_1)
node_node_2=preprocess_adj(node_node_2)
node_laplacian_1=preprocess_adj(node_laplacian_1)
node_laplacian_2=preprocess_adj(node_laplacian_2)
...
node_laplacian_1=node_laplacian_1.toarray()
node_laplacian_2=node_laplacian_2.toarray()


supports=[node_laplacian_1,node_laplacian_2]
...
for _ in range(10):
    ...
    for epoch in range(FLAGS.epoches):
        ...
        print('iter: {},  acc of test: {:5f}, auc of test: {:5f}, F1_score of test: {:5f}, recall of test: {:5f}'.format(epoch, acc_test, auc_test, F1_test, recall_test))
