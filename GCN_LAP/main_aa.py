...
aut_aut_1,aut_aut_2,aut_laplacian_1,aut_laplacian_2,aut_ins,aut_pap,adj,efeature=extract_adj(FLAGS.dataset)
...
aut_laplacian_1=preprocess_adj(aut_laplacian_1)
aut_laplacian_2=preprocess_adj(aut_laplacian_2)
aut_laplacian_1 = aut_laplacian_1.toarray()
aut_laplacian_2 = aut_laplacian_2.toarray()
aut_ins=preprocess_features(aut_ins)
aut_pap=preprocess_features(aut_pap)
aut_laplacian_1 = np.nan_to_num(aut_laplacian_1)
aut_laplacian_2 = np.nan_to_num(aut_laplacian_2)

supports=[aut_laplacian_1,aut_laplacian_2]
