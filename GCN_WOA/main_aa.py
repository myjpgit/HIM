...
from GCN_WOA.models import GCN
from GCN_WOA.minibatch import MiniBatch
from sklearn.metrics import roc_auc_score
from sklearn.metrics import precision_score, recall_score, accuracy_score
import numpy as np
from GCN_WOA.utils import *
import os
...
aut_att,ins_att,pap_att=extract_feature(FLAGS.dataset)
aut_att=sparse_to_tuple(aut_att)
...
hetero_input_dim=[aut_att[2][1]]
hetero_support=[aut_att]
hetero_feature=[aut_att]
